<?php
    ...
    if(isset($_GET['fecha1']) && isset($_GET['nombre1']) && isset($_GET['monto1']) && isset($_GET['tamaño'])){
        ...
        $reporte->Ln(4);
        $reporte->MultiCell(190,8,utf8_decode('A continuación se muestran los detalles de los ingresos que se tuvieron en la empresa en el transcurso del mes de '.$meses[$mes-1].' del año '.$año.', todos los ingresos mostrados en la parte inferior se obtuvieron de los detalles de las matrículas (montos pagados) que tuvieron los clientes durante ese lapso de tiempo.'),0,'L');
        ...
        $reporte->Cell(160,8,"INGRESO TOTAL DEL MES",1,0,'C');
        ...
        $reporte->OutPut('D','Ingresos - '. $meses[$mes-1] .' '. $año.'.pdf');
