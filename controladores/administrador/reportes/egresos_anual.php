<?php
    ...
    if(isset($_GET['fecha1']) && isset($_GET['nombre1']) && isset($_GET['monto1']) && isset($_GET['tamaño'])){
        ...
        $reporte->Ln(4);
        $reporte->MultiCell(190,8,utf8_decode('A continuación se muestran los detalles de los egresos que se tuvieron en la empresa en el transcurso del año '.$año.', todos los egresos mostrados en la parte inferior se obtuvieron de los detalles de los contratos (sueldos pagados) que tuvieron los entrenadores de la empresa durante el transcurso del año mencionado.'),0,'L');
        ...
        $reporte->Cell(160,8,utf8_decode("EGRESO TOTAL DEL AÑO"),1,0,'C');
        ...
        $reporte->OutPut('D',utf8_decode('Egresos - año '). $año.'.pdf');
